...
Homo_matrix=[1.1148968,	0.29303497,	-1.9025118e-05;
-0.39301369,	1.1039032,	-3.5306584e-05;
282.06497,	-825.51031,	1];
a=zeros(1,100);
b=zeros(1,100);
for i=1:100
    a(i)=1.1148968*p_org.Location(i,1)+0.29303497*p_org.Location(i,2)-1.9025118e-05-p_tran.Location(i,1);
    b(i)=-0.39301369*p_org.Location(i,1)+1.1039032*p_org.Location(i,2)-3.5306584e-05-p_tran.Location(i,2);
end
x_mse=mse(a(:,1));
y_mse=mse(b(:,2));
